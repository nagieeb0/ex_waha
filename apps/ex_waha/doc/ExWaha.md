# `ExWaha`
[🔗](https://github.com/nagieeb/ex_waha/blob/v0.1.0/lib/ex_waha.ex#L1)
...
Either a WAHA or Meta account struct.
...
An `ExWaha.Recipient` struct or a phone string. Strings get normalized.
